...
void DRV_CAN0_Initialize(void)
{
    ...
    /* Configure CAN_ID_1 Channel for CAN_RX_FULL_RECEIVE operation. Allocate 1 message buffer, and assign low medium priority for transmissions. */
    PLIB_CAN_ChannelForReceiveSet(CAN_ID_1, CAN_CHANNEL2, 1, CAN_RX_FULL_RECEIVE);
    PLIB_CAN_FilterToChannelLink(CAN_ID_1, CAN_FILTER1, CAN_FILTER_MASK0, CAN_CHANNEL2);
    PLIB_CAN_ChannelEventEnable(CAN_ID_1, CAN_CHANNEL2, CAN_RX_CHANNEL_NOT_EMPTY);
    /* Configure CAN_ID_1 Channel for CAN_RX_FULL_RECEIVE operation. Allocate 1 message buffer, and assign low medium priority for transmissions. */
    PLIB_CAN_ChannelForReceiveSet(CAN_ID_1, CAN_CHANNEL3, 1, CAN_RX_FULL_RECEIVE);
    PLIB_CAN_FilterToChannelLink(CAN_ID_1, CAN_FILTER2, CAN_FILTER_MASK0, CAN_CHANNEL3);
    PLIB_CAN_ChannelEventEnable(CAN_ID_1, CAN_CHANNEL3, CAN_RX_CHANNEL_NOT_EMPTY);
    /* Configure CAN_ID_1 Channel for CAN_RX_FULL_RECEIVE operation. Allocate 1 message buffer, and assign low medium priority for transmissions. */
    PLIB_CAN_ChannelForReceiveSet(CAN_ID_1, CAN_CHANNEL4, 1, CAN_RX_FULL_RECEIVE);
    PLIB_CAN_FilterToChannelLink(CAN_ID_1, CAN_FILTER3, CAN_FILTER_MASK0, CAN_CHANNEL4);
